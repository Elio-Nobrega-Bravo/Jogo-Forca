...
function exibirDerrota() {
  tabuleirotablero.font = ' bold 42px Inter';
  tabuleirotablero.lineWidth=6
  tabuleirotablero.lineCap="round"
  tabuleirotablero.lineJoin="round"
  tabuleirotablero.fillStyle="red"
  tabuleirotablero.fillText("Fim de jogo!",930,320)
}
